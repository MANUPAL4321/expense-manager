        ...
        <div className="profile-section" ref={dropdownRef}>
          ...
          {showDropdown && (
            <div className="profile-dropdown" id="profile-dropdown">
              ...
              <Link to="/balance" className={`dropdown-item ${location.pathname === '/balance' ? 'active' : ''}`} onClick={() => setShowDropdown(false)} id="dropdown-balance">
              ...
              <Link to="/reports" className={`dropdown-item ${location.pathname === '/reports' ? 'active' : ''}`} onClick={() => setShowDropdown(false)} id="dropdown-reports">
